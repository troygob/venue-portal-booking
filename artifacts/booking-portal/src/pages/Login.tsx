...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-navy-deep px-4 py-10 relative overflow-hidden">
      {/* Decorative arcs evoking the university seal */}
      ...
      <div className="relative w-full max-w-sm flex flex-col items-center mb-6 text-center">
        <div className="w-14 h-14 rounded-2xl bg-gold flex items-center justify-center mb-4" style={{ boxShadow: '0 4px 12px rgb(10 44 84 / 0.12)' }} aria-hidden="true">
      ...
      <div className="relative w-full max-w-sm bg-card border border-line rounded-2xl overflow-hidden" style={{ boxShadow: '0 4px 12px rgb(10 44 84 / 0.12)' }}>
        <form
        ...
        <div className="border-t border-line bg-navy-light p-5" style={{ background: 'rgba(231,238,248,0.4)' }}>
          ...
          <div className="grid grid-cols-2 gap-2">
            {DEMO_ROLES.map((r) => (
              <button
                ...
                type="button"
                onClick={() => enterDemo(r)}
                className="text-xs font-semibold border border-line rounded-lg px-3 py-2.5 bg-card hover:bg-navy-light hover:border-navy text-left transition-colors"
              >
                {ROLE_LABELS[r]}
              </button>
            ))}
